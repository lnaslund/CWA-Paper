...
### creating correlation matrix for predictors
t<-difference_no3[complete.cases(difference_no3),]
predictors<-data.frame(urban=t$urban,urban.delta=t$urban.delta,ag=t$ag,ag.delta=t$ag.delta,fert=t$fertilizer,
                       fert.delta=t$fertilizer.delta,feed=t$feed,feed.delta=t$feed.delta,undeveloped=t$undeveloped,
                       undeveloped.delta=t$undeveloped.delta,pop=t$pop,pop.delta=t$pop.delta,tmdl=t$tmdl.sites.sq.km,
                       money=t$total.money.sq.km,lake.p=t$lake.p.criteria,lake.n=t$lake.n.criteria,stream.n=t$stream.n.criteria,
                       stream.p=t$stream.p.criteria)

correlation.matrix<-cor(predictors)
write.csv(correlation.matrix,file="./results/predictor_correlation_matrix.csv")
...
for (i in 1:nsims){
  ...
  model.money.wlr<-lm(slope.wlr~total.money.sq.km,data=d)
  model.money.slr<-lm(slope.slr~total.money.sq.km,data=d)
  model.money.wlr.z<-lm(slope.wlr~money.z,data=d)
  model.money.slr.z<-lm(slope.slr~money.z,data=d)
  
  model.criteria.wlr<-lm(slope.wlr~stream.n.criteria,data=d)
  model.criteria.slr<-lm(slope.slr~stream.n.criteria,data=d)
  model.criteria.wlr.z<-lm(slope.wlr~stream.n.criteria.z,data=d)
  model.criteria.slr.z<-lm(slope.slr~stream.n.criteria.z,data=d)
  
  model.tmdl.wlr<-lm(slope.wlr~tmdl.sites.sq.km,data=d)
  model.tmdl.slr<-lm(slope.slr~tmdl.sites.sq.km,data=d)
  model.tmdl.wlr.z<-lm(slope.wlr~tmdl.z,data=d)
  model.tmdl.slr.z<-lm(slope.slr~tmdl.z,data=d)
  
  null.wlr<-lm(slope.wlr~1,data=d)
  s.null.wlr<-summary(null.wlr)
  null.slr<-lm(slope.slr~1,data=d)
  ...
  z.scores.models.wlr<-data.frame(model.type="WLR.z",policy=c("tmdl","319","criteria"),
                              ...
                              coef.se=c(model.tmdl.wlr.z.summary$coefficients[2,2],
                                        model.money.wlr.z.summary$coefficients[2,2],
                                        model.criteria.wlr.z.summary$coefficients[2,2]))
  ...
  z.scores.models.slr<-data.frame(model.type="SLR.z",policy=c("tmdl","319","criteria"),
                                  coef=c(coef(model.tmdl.slr.z)[2],
                                         coef(model.money.slr.z)[2],
                                         coef(model.criteria.slr.z)[2]),
                                  se.coef=c(model.tmdl.slr.z.summary$coefficients[2,2],
                                          model.money.slr.z.summary$coefficients[2,2],
                                          model.criteria.slr.z.summary$coefficients[2,2]))
  ...
  wlr.models.output<-data.frame(model.type="WLR",policy=c("tmdl","319","criteria"),
                                coef=c(coef(model.tmdl.wlr)[2],
                                       coef(model.money.wlr)[2],
                                       coef(model.criteria.wlr)[2]),
                                coef.se=c(model.tmdl.wlr.summary$coefficients[2,2],
                                          model.money.wlr.summary$coefficients[2,2],
                                          model.criteria.wlr.summary$coefficients[2,2]))
  ...
  slr.models.output<-data.frame(model.type="SLR",policy=c("tmdl","319","criteria"),
                                coef=c(coef(model.tmdl.slr)[2],
                                       coef(model.money.slr)[2],
                                       coef(model.criteria.slr)[2]),
                                coef.se=c(model.tmdl.slr.summary$coefficients[2,2],
                                          model.money.slr.summary$coefficients[2,2],
                                          model.criteria.slr.summary$coefficients[2,2]))
...
for (i in 1:nsims){
  ...
  z.scores.models.wlr<-data.frame(model.type="WLR.z",policy=c("tmdl","319","criteria"),
                                  coef=c(coef(model.tmdl.wlr.z)[2],
                                         coef(model.money.wlr.z)[2],
                                         coef(model.criteria.wlr.z)[2]),
                                  coef.se=c(wlr.z.tmdl.summary$coefficients[2,2],
                                            wlr.z.money.summary$coefficients[2,2],
                                            wlr.z.criteria.summary$coefficients[2,2]))
  ...
  z.scores.models.slr<-data.frame(model.type="SLR.z",policy=c("tmdl","319","criteria"),
                                  coef=c(coef(model.tmdl.slr.z)[2],
                                         coef(model.money.slr.z)[2],
                                         coef(model.criteria.slr.z)[2]),
                                  coef.se=c(slr.z.tmdl.summary$coefficients[2,2],
                                            slr.z.money.summary$coefficients[2,2],
                                            slr.z.criteria.summary$coefficients[2,2]))
  ...
  output.slr<-data.frame(model.type="SLR",policy=c("tmdl","319","criteria"),
                         coef=c(coef(model.tmdl.slr)[2],
                                coef(model.money.slr)[2],
                                coef(model.criteria.slr)[2]),
                         coef.se=c(slr.tmdl.summary$coefficients[2,2],
                                   slr.money.summary$coefficients[2,2],
                                   slr.criteria.summary$coefficients[2,2]))
  ...
  output.wlr<-data.frame(model.type="WLR",policy=c("tmdl","319","criteria"),
                         coef=c(coef(model.tmdl.wlr)[2],
                                coef(model.money.wlr)[2],
                                coef(model.criteria.wlr)[2]),
                         coef.se=c(wlr.tmdl.summary$coefficients[2,2],
                                   wlr.money.summary$coefficients[2,2],
                                   wlr.criteria.summary$coefficients[2,2]))
...
write.csv(z_scores_plot_melt,"./data/clean_data/z_scores_estiamtes_supplement.csv")
...
write.csv(summarized.non.z,"./results/non_z_scored_estiamtes_supplement.csv")
